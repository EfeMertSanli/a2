...
public final class Constants {
    ...
    public static final class Error {
        ...
        /**
         * Error message when graph is null.
         */
        public static final String GRAPH_MUST_NOT_BE_NULL = "Graph must not be null";
        /**
         * Error message for invalid load database command format.
         */
        public static final String INVALID_LOAD_DATABASE_FORMAT = "Invalid load database command format: ";
        /**
         * Error message for duplicate product ID.
         */
        public static final String DUPLICATE_PRODUCT_ID = "Duplicate product ID ";
        /**
         * Error message part for different names.
         */
        public static final String FOUND_WITH_DIFFERENT_NAMES = " found with different names: ";
        /**
         * Connector string for error messages.
         */
        public static final String AND = " and ";
        /**
         * Error message part for line reference.
         */
        ...
        /**
         * Error message for product ID.
         */
        public static final String PRODUCT_ID = "Product ID ";
        /**
         * Error message for existing entity with different ID.
         */
        public static final String EXISTS_WITH_DIFFERENT_ID = " already exists with a different ID";
        /**
         * Error message for existing entity with different name.
         */
        public static final String EXISTS_WITH_DIFFERENT_NAME = " already exists with a different name";
        /**
         * Error message for invalid relationship between nodes.
         */
        public static final String INVALID_RELATIONSHIP_BETWEEN = "Invalid relationship between ";
        /**
         * Error message for failed edge addition.
         */
        public static final String FAILED_TO_ADD_EDGE = "Failed to add edge: ";
        /**
         * Error message for command that must start with 'recommend'.
         */
        public static final String MUST_START_WITH_RECOMMEND = "Command must start with 'recommend'";
        /**
         * Error message for null strategies.
         */
        public static final String STRATEGIES_MUST_NOT_BE_NULL = "Strategies must not be null";
        /**
         * Error message for null term.
         */
        public static final String TERM_MUST_NOT_BE_NULL = "Term must not be null";
        /**
         * Error message for relationship operation with no database.
         */
        public static final String CANNOT_ADD_RELATIONSHIP_NO_DATABASE = "Cannot add relationship - no database loaded";
        /**
         * Private constructor to prevent instantiation of this utility class.
         */
        private Error() {
